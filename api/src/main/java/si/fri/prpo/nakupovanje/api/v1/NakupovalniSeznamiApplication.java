...
@OpenAPIDefinition(
        info = @Info(
                title = "Nakupovalni seznami REST API",
                version = "v1",
                contact = @Contact(name = "Simen Ravnik, Jure Vito Srovin"),
                license = @License(), description = "REST API za dodajanje in urejanje nakupovalnih seznamov"),
